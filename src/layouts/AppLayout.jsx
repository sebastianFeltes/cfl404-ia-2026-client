 ...
 * Incluye:
 *   • Header sticky con logo y navegación responsive
 *   • Drawer mobile con animación
 *   • Footer institucional
 *   • Outlet para: Home, Institucional, Cooperadora, Cursos
 */
function AppLayout() {
        ...
        <div className="min-h-screen flex flex-col bg-gray-50 font-roboto text-custom-gris-oscuro">
            ...
            <header className="sticky top-0 z-40 bg-custom-azul-oscuro text-white shadow-md">
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <NavLink
                        to="/admin"
                        className="hidden md:flex items-center gap-1.5 text-xs font-nunito font-semibold text-white/60 hover:text-white/90 transition-colors ml-4 border-l border-white/20 pl-4"
                    >
                        Panel Admin →
                    </NavLink>
                ...
                >
                    ...
                    <nav className="flex flex-col gap-3">
                        ...
                        <NavLink
                            to="/admin"
                            onClick={closeMenu}
                            className="flex items-center gap-4 font-nunito font-bold text-lg p-3 rounded-xl transition-all text-white/60 hover:bg-white/10"
                        >
                            Panel Admin →
                        </NavLink>
                    </nav>
            ...
            <footer className="bg-custom-gris-oscuro text-custom-blanco py-6 mt-auto border-t border-gray-800">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-sm font-nunito text-gray-400">
                        Contacto:{' '}
                        <a href="mailto:cooperadora@cfl404.edu.ar" className="text-custom-celeste hover:underline transition-colors">
